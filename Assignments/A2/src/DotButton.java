...
/**
 * In the application <b>com.harshgupta.Minesweeper</b>, a <b>com.harshgupta.DotButton</b> is a specialized type of
...
public class DotButton extends JButton {
     ...
     /**
     * predefined values to capture icons of a com.harshgupta.DotInfo
     */
    ...
    /**
     * Constructor used for initializing a com.harshgupta.DotButton at a specific
    ...
    // ADD YOU CODE HERE
        ...
        //get the image for this dot button and set the icon to that image.
    ...
    // ADD YOU CODE HERE
        ...
        //change the value of the instance variable to the passed parameter.
        this.iconNumber = iconNumber;

        //reset the icon for this instance, set the border to null.
        this.setIcon(getImageIcon());
        this.setBorder(null);
    }
